...
using LiveSplit.IRLTimesave.UI.Components;

namespace LiveSplit.UI.Components
{
    public class IRLTimesaveComponent : IComponent
    {
        ...
        public IRLTimesaveSettings Settings { get; set; }
        ...
        // already added.
        public IRLTimesaveComponent(LiveSplitState state)
        {
