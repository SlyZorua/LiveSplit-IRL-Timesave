...
{
    public class IRLTimesaveFactory : IComponentFactory
    {
        ...
        public IComponent Create(LiveSplitState state) => new IRLTimesaveComponent(state);
